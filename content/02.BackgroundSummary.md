...
Biological assemblages are becoming progressively more similar to each other globally, as local and endemic species go extinct and are replaced by more widespread and competitive native or alien species (@ipbes2019; @doi:10.1038/s41559-020-1176-8; @doi:10.1101/2020.09.08.287938). 
...
As they normally contain information on the relative cover or abundance of each species, vegetation plots are also more appropriate for detecting biodiversity and biomass changes than data representing only the occurrence of individual species (@doi:10.1111/j.1654-1103.2011.01318.x).  
