...
We based the quantification of variability in plant species composition among the 50 randomly selected vegetation plots by computing the mean and the variance of the Jaccard’s dissimilarity index (@doi:10.1111/j.1469-8137.1912.tb05611.x) between all possible pairs of these 50 vegetation plots (n = 1225). 
